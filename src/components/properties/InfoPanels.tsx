import type { FieldInfo, GroupInfo, RecordInfo, SchemaInfo } from '@/model/types';
import { Case, CharacterType, ChildOrder, Justification, ParserOptimization, StructureType } from '@/model/types';
import {
  BoolField,
  CharacterPairField,
  EnumField,
